...
module.exports = {
 ...
 // ["link", { rel: "stylesheet", href: "https://fonts.googleapis.com/css?family=Noto+Serif+JP" }],
    ...
    ["link", { rel: "stylesheet", href: "https://cdnjs.cloudflare.com/ajax/libs/jquery-bootgrid/1.3.1/jquery.bootgrid.min.css", /*integrity: "sha256-i397iDijTcJqMf2j733J1b+WKakC2U8Y3k2eMScEugA=",*/ crossorogin: "anonymous" }],
 ...
 // ["script", { src: "/nehan/js/nehan.min.js", charset: "UTF-8", defer: true }],
    ...
    ["script", { src: "https://cdnjs.cloudflare.com/ajax/libs/jquery-bootgrid/1.3.1/jquery.bootgrid.min.js", integrity: "sha256-S952WuaxC9XbI06xeWuSuSuvTewXEQQOU2OYBe7kdIs=", crossorigin: "anonymous" }],
    ["script", { src: "https://cdnjs.cloudflare.com/ajax/libs/jquery-bootgrid/1.3.1/jquery.bootgrid.fa.min.js", integrity: "sha256-u/DZtNLWZSvkNdIL4PTQzEJUAFLzM758asxZnhd+5R4=", crossorigin:"anonymous" }]
  ],
  plugins: [
